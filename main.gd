...
func show_database_dialog_create() -> void:
	...
	_database_create_dialog.database_created.connect(func on_database_created(database: AbstractDatabase) -> void:
		_database_path = ""
...
func show_open_file_dialog() -> void:
	...
	_database_load_dialog.database_loaded.connect(func on_database_loaded(database: AbstractDatabase, path: String) -> void:
		_database_path = path
