...
static func _static_init() -> void:
	register(&"bool",          load("res://scripts/database/impl/data_types/bool_data_type.gd").new)
	register(&"color",         load("res://scripts/database/impl/data_types/color_data_type.gd").new)
	register(&"float",         load("res://scripts/database/impl/data_types/float_data_type.gd").new)
	register(&"float_range",   load("res://scripts/database/impl/data_types/float_range_data_type.gd").new)
	register(&"int",           load("res://scripts/database/impl/data_types/int_data_type.gd").new)
	register(&"int_enum",      load("res://scripts/database/impl/data_types/int_enum_data_type.gd").new)
	register(&"int_range",     load("res://scripts/database/impl/data_types/int_range_data_type.gd").new)
	register(&"string",        load("res://scripts/database/impl/data_types/string_data_type.gd").new)
	register(&"string_enum",   load("res://scripts/database/impl/data_types/string_enum_data_type.gd").new)
	register(&"string_name",   load("res://scripts/database/impl/data_types/string_name_data_type.gd").new)
